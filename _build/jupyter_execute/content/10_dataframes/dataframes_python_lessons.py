...
# 
# In this module you will learn how to work with OpenSesame datasets using the python package Pandas. The video and lesson we supply here were created by Todd M Gureckis, and released under [the creative commons license](http://teaching.gureckislab.org/fall22/labincp/LICENSE.html). First, watch the video, then follow along with this explanation on dataframes and pandas:
# 
...
# 
# Before we get too many numbers we need to start thinking abstractly about **organzing** our measurements into some type of collection.  In our previous chapter on the [basics of Python](http://teaching.gureckislab.org/fall22/labincp/chapters/03/00-python) we discussed the concept of [collections](http://teaching.gureckislab.org/fall22/labincp/chapters/03/00-python.html#collections).  Collections are things in the native Python language space that organize multiple numbers, string, or even other collections.  This included [lists](http://teaching.gureckislab.org/fall22/labincp/chapters/03/00-python.html#lists) (which organize things in some order), [dictionaries](http://teaching.gureckislab.org/fall22/labincp/chapters/03/00-python.html#dictionaries) (which do not preseve order but allow "looking up" the value of a number by a special address known as a key), or [sets](http://teaching.gureckislab.org/fall22/labincp/chapters/03/00-python.html#sets) (which are unordered collections of things useful for counting, and performing set operations like union, etc...).
# 
# 
