## Proposal Course description Experimentation I 2022-2023
...
#### Assessment method
Weekly assignments to program Python code (approximately 4-10 lines). 75% of these assignments need to be marked as a pass.
Programming an experiment using Python code in OpenSesame and providing code for basic behavioral analysis within a time limit (of 3 hours).

Reading list N/A. 
Course material will be (made) available online
Contact information
Course coordinator: Dr. Henk van Steenbergen HvanSteenbergen@fsw.leidenuniv.nl

Hours / ECs: 5 EC cursus
